...
export default class GraphQL extends Component {
    ...
    performSearch() {
        ...
        .then( (data) => {
            console.log("[GraphQL][performSearch] => (data):", data);
    ...
    componentDidMount() {
        ...
        .then( (response) => response.json() )
        .then( (data) => {
            console.log("[GraphQL][componentDidMount] => (data):", data);
        ...
        return (
            <Fragment>
                ...
                <div className="list-group">
                    {movies.map( (m) => (
                        <a key={m.id} href="#!" className="list-group-item list-group-item-action">
